...
export default function UnderConstruction() {
  ...
  // Simple loading timeout - show content after a short delay
  useEffect(() => {
  ...
  if (isLoading) {
    return (
      <div 
        className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#18181b] bg-opacity-90"
        style={{ 
          width: "100vw",
          height: "100vh"
        }}
  ...
  return (
    <div 
      className="relative flex items-center justify-center overflow-hidden transition-opacity duration-500 opacity-100"
      style={{ 
        backgroundColor: "#f5f5f5", // Fallback color
        backgroundImage: "url('/under-construction-bg/pnoi_background.png')",
